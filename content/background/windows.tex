...
\begin{itemize}
    ...
    \item[Clear key] unprotected 256-bit key stored on the volume to decrypt vmk
        ...
        \begin{figure}[htb]%
            \centering
            \includesvg{bitlocker_volume_access_stack.drawio.svg}
