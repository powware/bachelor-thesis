...
Together with the file section type \code{EFI\underbreak SECTION\underbreak FIRMWARE\underbreak VOLUME\underbreak IMAGE} which contains an entire \ac{PI} \ac{FV} image, this makes up for the \ac{FFS}'s lack of a directory structure.
...
The dispatcher also makes use of the two \nameref{sec:appendix:protocols:security:architectual:protocols} to authenticate each \ac{DXE} driver and decide whether to execute it \cite[Vol. 2, 10.13]{pi-spec}.
