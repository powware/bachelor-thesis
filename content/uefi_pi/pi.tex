...
% https://3762986563-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5spcVt2sqlUZOWmnXY%2F-M5sphJDWD7_iUuoREya%2F-M5spjqkdHzNxeIs2rlZ%2Fimage6.png?generation=1587944061953355&alt=media
\TODO{MAYBE add this image?}
...
The \ac{TSL} phase constist of the \ac{UEFI} \ac{OS} boot loader performing its necessary actions in preparation of assuming control over the system by calling \code{ExitBootServices()} and transfering execution to the \ac{OS} kernel \cite[Section 2.3]{tianocore-edk2-build-spec}.
