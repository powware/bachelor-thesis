...
The dispatcher also makes use of a \emph{Security Architectural Protocol} to authenticate each \ac{DXE} driver to decide whether or not to execute it \cite[Vol. 2, 10.13]{pi-spec}.
