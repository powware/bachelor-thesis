...
If a driver needs to be uninstalled from a specific controller, the firmware can call the \code{Stop} of the Driver Binding Protocol function on the controller handle.
...
\lstinputlisting[language=C,caption={\ac{UEFI} Image Entry Point},captionpos=b,label=lst:entry-point]{code/entry_point.c}
