...
Windows 11 is the latest iteration in the line of the desktop \ac{OS} by Microsoft at the time of writing.
...
It does not support legacy \ac{BIOS} anymore and requires the \ac{PF} to conform to at least \ac{UEFI} version 2.3.1 and it must be capable of Secure Boot.
