...
There is no one\-/to\-/one mapping of a registry root key to a hive file, the \ac{BCD} file, for example, is also a hive file and is mapped into the Registry under \program{HKEY\underbreak LOCAL\underbreak MACHINE\brackslash BCD00000000} \cite[Section 10]{windows-internals-7-part2}.
