...
Windows then forces BitLocker to use a default validation profile of \hyperref[tab:pcr-usage]{\code{\{7, 11\}}}, leaving out \ac{PCR}0 where our rookit is measured to.
