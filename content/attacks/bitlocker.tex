...
The default validation profile \hyperref[tab:pcr-usage]{\code{\{7, 11\}}} used, when Secure Boot takes care of integrity validation is covered in \autoref{sec:attacks:bitlocker:bitlocker-access-without-recovery-prompt}.
