...
Since our \ac{UEFI} payload is executed before the Windows Boot Manager, we can query all instances of the \nameref{lst:simple-text-input-ex-protocol} and change each function pointer of \code{ReadKeyStrokeEx()} to point to our function hook.
