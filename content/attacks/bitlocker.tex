...
\lstinputlisting[language=C,captionpos=b,label=lst:private-data,firstline=6,caption={Example of a driver using private data in the implementation of the \emph{Disk I/O Protocol} (snipptets from 8.2 and 8.5 \cite{tianocore-edk2-driver-writer-s-guide})}]{code/private_data.c}
...
%\cite[12.7]{tcg-tpm-library-part3-commands}
