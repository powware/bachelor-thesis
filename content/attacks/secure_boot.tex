...
\lstinputlisting[language=C,caption={DxeImageVerificationHandler Reference Implementation},captionpos=b,label=lst:dxe-image-verification-handler]{code/dxe_image_verification_handler.c}