...
A secondary copy of the task descriptors exists within the regular file system under \program{\%windir\%\brackslash system32\brackslash Task}, stored in the form of \ac{XML} files.
