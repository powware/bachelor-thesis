...
Function calls related to standard input and output such as opening, reading and writing a file, namely the hive file, are more complex and have to be mapped to \ac{UEFI} protocols like \emph{Simple File System Protocol} and \lstinline{FileProtocol}.
