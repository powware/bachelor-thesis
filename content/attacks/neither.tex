...
For this we can use the open source NTFS driver ntfs-3g from Tuxera \cite{ntfs-3g} which supports read and write access, there already exists a port to UEFI created by pbatard \cite{ntfs-3g-uefi}.
