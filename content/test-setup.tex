...
For Secure Boot, we generate our own \ac{PK} and use the \ac{KEK} and the two signature \acp{DB} provided by Microsoft: \emph{Microsoft Corporation \acs{KEK} \acsu{CA} 2011}, \emph{Microsoft Windows Production PCA 2011} and \emph{Microsoft Corporation UEFI CA 2011}.
...
For BitLocker and to fulfill Windows 11's general requirement of a \ac{TPM} 2.0 to be present, we use \program{swtpm}, a \ac{TPM} emulated in software \cite{swtpm}.
