...
\lstinputlisting[language=C,firstline=4,caption={Firmware Volume2 Protocol},captionpos=b,label=lst:firmware-volume2-protocol]{code/protocols/FirmwareVolume2.h}
\clearpage
