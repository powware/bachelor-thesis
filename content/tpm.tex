...
Its implementation can be accomplished through dedicated hardware or by using the \acsu{CPU}'s isolated \ac{SMM} \cite[Section 9.3]{tcg-tpm-library-part1-architecture}.
