...
It is hinting to the user, that the removal of a disk or \ac{USB} stick might fix the issue.
...
Microsoft allowing this security override created a dangerous precedent, especially since they do not display any warnings about the inherent danger.
...
System designers can also take into account making it harder to access the flash, so an attacker will have trouble modifying the firmware image.